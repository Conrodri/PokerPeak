...
- **Commit obligatoire à chaque fin de tâche** — à la fin de chaque tâche (une fois le travail testé et propre), **toujours commit** sans attendre de demande explicite. Ne **jamais push** automatiquement pour autant : le push reste soumis à un accord explicite de l'utilisateur dans la conversation en cours.
